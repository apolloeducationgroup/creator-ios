...
@synthesize fields=_fields,application=_application,hasEditOnLoad=_hasEditOnLoad,hasOnLoad=_hasOnLoad,isStateful=_isStateful,buttons=_buttons,successMessage=_successMessage,dateFormat=_dateFormat;
